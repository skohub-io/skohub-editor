...
# Default-Stop:      0 1 6
# Short-Description: skohub-editor as a node server
# Description:       skohub-editor as a node server available via http
### END INIT INFO

# this file should be placed into /etc/init.d/
### if you copy it to init.d:
# set the home directory to your skohub-editor installation as an absolute path:
HOME_=$HOME
### END copy to init.d

PATH=/usr/local/sbin:/usr/local/bin:/sbin:/bin:/usr/sbin:/usr/bin
HOME_EDITOR=$HOME_/git/skohub-editor/scripts/
DAEMON_START_SCRIPT=$HOME_EDITOR/start.sh
NAME=skohub-editor
PID_FILE=$HOME_EDITOR/$NAME.pid
DESC="skohub-editor as a node server"
RUN_AS_USER=lod
